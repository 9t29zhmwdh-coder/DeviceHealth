# Copilot Instructions for DeviceHealth
AI-powered system diagnostics and health monitoring, built with Rust and Tauri. It analyzes processes, services, hardware, and network activity locally, detects problems, and explains them in plain language via Ollama, with no cloud connection involved.
## Code style
