...
**AI-powered system diagnostics and health monitoring — fully offline, built with Rust + Tauri.**
...
| Feature | Description |
|---|---|
| **Health Score** | Numerical 0–100 rating with grade (Excellent → Critical) |
